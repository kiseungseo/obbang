...
public class AttachFileCheckTask {
	...
	public void storecheckFiles() throws Exception{	
		...
		// DB에 저장된 파일 리스트
		List<ImageVO> fileList = mapper.storeCheckFileList();		
	...
	@Scheduled(cron="0 0 1 * * *")
	public void menucheckFiles() throws Exception{	
		...
		// DB에 저장된 파일 리스트
		List<ImageVO> fileList = mapper.menuCheckFileList();		
