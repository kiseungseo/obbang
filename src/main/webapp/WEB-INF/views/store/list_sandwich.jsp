...
<%@include file="../includes/header.jsp"%>
									...
									<div class="product-item">
										<div class="pi-pic">
											<div class="image_wrap"
												...
												<a href="/store/category_sandwich?store_id=${list.store_id }"><img
													style="width: 250px; height: 150px;"></a>
											</div>
										</div>
										<div class="pi-text">
											<div class="catagory-name">${list.store_category}</div>
											<a href="/store/category_sandwich?store_id=${list.store_id }">
	...
	<form id="moveForm" action="/store/list_sandwich" method="get">
	...
	<script>
		...
		$(".pageMaker_btn a").on("click", function(e){
			...
			var storeCategory = "sandwich"; // 전달하고자 하는 데이터 값
