				...
				<div class="col-lg-12">
					<div class="breadcrumb-text product-more">
						<a href=/store/home><i class="fa fa-home"></i> Home</a> <a
							href="/store/list_bread?store_category=bread">Shop</a> <span>Bread</span>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<c:forEach items="${list}" var="list">
								<div class="product-pic-zoom image_wrap"
						...
						<div class="product-item">
							<div class="pi-pic">
								<div class="image_wrap"
									...
									data-uuid="${list.imageList[0].uuid}"
									data-filename="${list.imageList[0].fileName}">
									<a href="/store/detail_bread?menu_id=${list.menu_id }"><img
