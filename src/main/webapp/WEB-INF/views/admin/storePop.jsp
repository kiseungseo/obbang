...
<!DOCTYPE html>
<html>
<link rel="stylesheet" href="../resources/css/admin/storePop.css">
<head>
<meta charset="UTF-8">
...
<body>
	...
	<div class="content_wrap">
		...
		<div class="author_table_wrap">
					...
					<table class="author_table">
						...
						<c:forEach items="${list}" var="list">
							<tr>
								...
								<td>
	                    				<a class="move" href='<c:out value="${list.store_store}"/>' data-name='<c:out value="${list.store_store}"/>'>
			...
			<!-- 게시물 x -->
			<c:if test="${listCheck == 'empty'}">
				<div class="table_empty">등록된 점포가 없습니다.</div>
			</c:if>

			<!-- 검색 영역 -->
			<div class="search_wrap">
				<form id="searchForm" action="/admin/storePop" method="get">
			...
			<form id="moveForm" action="/admin/storePop" method="get">
